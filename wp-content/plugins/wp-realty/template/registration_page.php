...
<?php }
	...
	<div class="rems_container cst_mr_cls">
	<?php
}
?>
		...
		{?>
			<div class="emgt_plan">
				<ul class="no-margin">
					...
					<li class="emgt_dyn_color"><?php echo emgt_get_currency_symbol(get_option("emgt_system_currency"))." ".$plan['price'];?></li>
		...
		<table class="tabel table-hover tbl-center no-margin reg_cont_box">			
			<tbody>
				<tr>
					...
					<td class="tbl-right"><?php  echo (get_option( 'emgt_system_phone' ) != "")?get_option( 'emgt_system_phone' ):" Not Available "; ?></td>
				</tr>
				<tr>
					<td><?php _e("Email","estate-emgt");?> :</td>
					<td class="tbl-right"><a href="mailto:<?php echo get_option( 'emgt_system_email' );?>"><?php echo (get_option( 'emgt_system_email' )!= "")?get_option( 'emgt_system_email' ):" Not Available "; ?></a></td>		
				</tr>
				<tr>
					<td><?php _e("Address","estate-emgt");?> :</td>		
					<td class="tbl-right"><?php  echo (get_option( 'emgt_system_address' )!= "")?get_option( 'emgt_system_address' ):" Not Available "; ?></td>	
				</tr>
				<tr>
					<td><?php _e("Country","estate-emgt");?> :</td>	
					<td class="tbl-right"><?php  echo (get_option( 'emgt_system_country' )!= "")?get_option( 'emgt_system_country' ):" Not Available "; ?></td>	
				</tr>
			</tbody>
		</table>	
		</div>
