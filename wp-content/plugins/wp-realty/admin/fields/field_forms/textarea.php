...
<form method="post" id="add_field_form">
			...
			<div class="form-group row">
				...
				<input type="text" name="f_type" id="f_type" class="col-sm-4" value="Textarea" readonly>		
			</div>
			...
			<div class="form-group row" id="def_val_div">						
				<label for="d_value" class="col-sm-3 text-right bold"><?php _e('Default Value','estate-emgt');?> :</label>
				<input type="text" name="d_value" id="d_value" class="col-sm-4" placeholder="<?php _e('Default Value','estate-emgt');?>" value="<?php if($edit) echo $data['default_value']; ?>">
				<label class="label_margin">&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="placeholder" id="placeholder" value="1" <?php if($edit) echo ($data['placeholder']) ?'checked':'';?>>&nbsp;<span class="text-muted"><?php _e('Use as placeholder','estate-emgt');?></span></label>
			</div>				
			<div class="form-group row" id="id_div">
			...
			<div class="form-group row" id="class_div">
