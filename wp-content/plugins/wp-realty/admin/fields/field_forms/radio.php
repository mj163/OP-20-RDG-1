...
<form method="post" id="add_field_form">
			...
			<div class="form-group row">
				...
				<input type="text" name="f_type" id="f_type" class="col-sm-4" value="Radio-Buttons" readonly>		
			</div>
			...
			<div class="form-group row" >						
				<label for="buttons" class="col-sm-3 text-right bold"><?php _e('Buttons','estate-emgt');?> :</label>
				<textarea name="buttons" id="buttons" class="col-sm-4 validate[required]" rows="3" placeholder="<?php _e('Add buttons','estate-emgt');?>"><?php if($edit) echo $data['options']; ?></textarea>	
				&nbsp;&nbsp;&nbsp;<label class="bg-primary form-control-label img-rounded"><?php _e('separate each button by','estate-emgt');?> '|' <br> <?php _e("example: 'button 1 | button 2'","estate-emgt"); ?> &nbsp;</label>			
			</div>
			<div class="form-group row">
