...
<table id="notes" class="display" cellspacing="0" width="100%">
	...
	<tbody>
	<?php 
		$notes = $db->emgt_get_rows("emgt_notes","task_id",$_GET['vid']);
		// $d2 = $db->emgt_get_rows("emgt_notes","inquiry_id",$inq);
